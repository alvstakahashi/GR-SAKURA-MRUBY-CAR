...
class MainThread < Ssp_thread
	...
	def thread(n)
		puts "start mainThread"
  		...
  		led2    = Rx_gpio.new(Rx_gpio::LED2)		#stear
  		stear    = Rx_gpio.new(Rx_gpio::IO12)
 		...
 		stear_timer   = Myalarm.new(2,stear)
		stear_loop    = Gpiocyclic.new(2,stear_timer,stear,led2)
